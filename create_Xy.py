...
features_to_use = ['bathrooms', 'bedrooms', 'rooms', 'latitude', 'longitude', 'price',
                   ...
                   'created_day_of_year', 'created_month', 'created_day_of_week', 'created_day',
...
category_features = ['building_code','street_code','adrs_code','area_qsmall_code',
                     'created_month','created_day','created_day_of_week',
                     'bedrooms','bathrooms','rooms']
category_features.remove('created_month')
					 
metrics = ['price','price_per_bed','price_per_bath','price_per_room',
           'bed_bath_rate','bed_bath_diff',
           'num_features','num_photos','num_description_words',
           'created_day_of_year'] + ambs_features + distance_features
...
for met_to_cut in metrics:
    ...
    print(met_to_cut,df[met_to_cut].unique().size)
    ...
    for met_to_cal in metrics:
        if met_to_cut == met_to_cal:
            break
        if met_to_cut in ambs_features and met_to_cal in ambs_features:
            break
